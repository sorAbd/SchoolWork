...
/**
 * The user picks a random integer from 10 to 99 and provides 
 ...
 *
 */
public class ComputerGuessProduct {
	...
	public static void main(String[] args) {
		...
		System.out.println("Pick a random integer from 10 to 99 and provide the product.");
		System.out.println("I will try to guess it in 3 turns");
		System.out.print("What is the product of your two numbers: ");
		Scanner scanner = new Scanner(System.in);
		String product = scanner.nextLine();
		//Compute guess 1 for the computer
		int guess1 = 10+ (int)(Math.random()*99);
