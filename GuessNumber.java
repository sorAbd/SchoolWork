 ...
 * Program 1: Guess number in 3 turns
 */
package m06a1p1;

import java.util.Scanner;
/**
 * The computer picks a random integer from 1 to 10
 * The user will try to guess it in three turns
...
public class GuessNumber {
	...
	public static void main(String[] args) {
		System.out.println("Guess Class by Soroush Abdollahi");
		//pick a random integer
		int hiddenNumber = 1 + (int)(Math.random()*10);
		System.out.println("I picked a number from 1 to 10");
		System.out.println("You have 3 turns to guess it.");
